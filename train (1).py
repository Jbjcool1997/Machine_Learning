...
from azure.ai.ml.sweep import Normal, Uniform, Choice, BanditPolicy, RandomSamplingAlgorithm
...
env = Environment.get(workspace=ws, name='JJ_ML_Project')  # Replace with your environment name
