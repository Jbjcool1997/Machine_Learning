...
#from azure.ai.ml.hyperdrive import HyperDriveConfig, RandomParameterSampling, BanditPolicy, PrimaryMetricGoal
#from azure.ai.ml.data import TabularDataset
...
ml_client = MLClient(
    ...
    subscription_id="610d6e37-4747-4a20-80eb-3aad70a55f43",  # Replace with your subscription ID
    resource_group_name="aml-quickstarts-276303",  # Replace with your resource group
    workspace_name="quick-starts-ws-276303"  # Replace with your workspace name
)

#environments = ml_client.environments.list()
#for env in environments:
#    print(f"Name: {env.name}, Version: {env.version},conda_file: {env.conda_file},build: {env.build}")


env = ml_client.environments.get('JJMLProject', version=1)  # Replace with your environment name and version

# Define the Docker environment
#docker_env = Environment(
#    name="JJMLProject",
#    docker=Environment.Docker(
#        image="mcr.microsoft.com/azureml/openmpi4.1.0-ubuntu20.04:20250224",  # Specify your Docker image
#        base_image_registry="mcr.microsoft.com",  # Specify the base image registry if needed
#    )
#)
# Register the environment
#ml_client.environments.create_or_update(docker_env)
...
#{}
    ...
    src = ScriptRunConfig(source_directory='.',  # Directory where train.py is located
                      script='train_HD_Mod.py',  # Your training script
                      compute_target= 'MLProj1',
                      environment=env.name)  # Your environment
